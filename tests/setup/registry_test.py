...
Module
    registry_test.py
Info
    Unit tests for GenSTM8BundleRegistry class.
'''
...
class TestGenSTM8BundleRegistry(unittest.TestCase):
    ...
    def test_create_bundle_success(self) -> None:
        ...
        bundle = GenSTM8BundleRegistry.create_bundle(dependencies)
    ...
    def test_create_bundle_invalid_dependencies(self) -> None:
        with self.assertRaises(Exception):
            GenSTM8BundleRegistry.create_bundle(None)

    def test_get_version(self) -> None:
        self.assertEqual(GenSTM8BundleRegistry.get_version(), '1.0.5')
