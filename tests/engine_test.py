...
class TestGenSTM8(unittest.TestCase):
    ...
    def test_engine_process_success(self) -> None:
        ...
        mock_base = BaseBundleFactory.create_bundle(
            options=BaseBundleOptions(
                info_file='gen_stm8/infrastructure/config/gen_stm8.cfg',
                use_generator=True,
    ...
    @patch('gen_stm8.setup.validator.GenSTM8BundleValidator.validate')
