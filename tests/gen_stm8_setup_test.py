...
Info
    Defines class STM8SetupTestCase with attribute(s) and method(s).
    Creates test cases for checking functionalities of STM8Setup.
Execute
    python3 -m unittest -v gen_stm8_setup_test
'''
...
class STM8SetupTestCase(TestCase):
    '''
        Defines class STM8SetupTestCase with attribute(s) and method(s).
        Creates test cases for checking functionalities of STM8Setup.
        STM8Setup unit tests.
