...
Info
    Validator for the gen_stm8 bundle dependencies.
'''
...
class GenSTM8BundleDependenciesValidator:
    '''
        Validator for the gen_stm8 bundle dependencies.
    ...
    @classmethod
    def validate(cls, dependencies: GenSTM8BundleDependencies) -> None:
        '''
            Validates the gen_stm8 bundle dependencies.

            :param dependencies: The gen_stm8 bundle dependencies to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_stm8_bundle_dependencies_validator::validate(...)'
        msg_dependencies_none: str = 'the gen_stm8 bundle dependencies must be provided'
        msg_dependencies_istype: str = 'the gen_stm8 bundle dependencies must be a Mapping'

        not_none(dependencies, ctx, msg_dependencies_none)
        istype(dependencies, Mapping, ctx, msg_dependencies_istype)

        for attr_name, expected_type in GenSTM8BundleKeys.get_dependency_to_type().items():
