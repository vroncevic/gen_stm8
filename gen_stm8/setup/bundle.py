...
class GenSTM8Bundle:
    '''
        GenSTM8 bundle holding the components of the gen_stm8.

        It defines:

            :attributes:
                | base - The base bundle with the base components.
                | service - The service orchestrating the gen_stm8's execution.
                | subprocessor - The adapter executing the gen_stm8's sub-processes.
                | cli - The command-line interface adapter.
            :methods:
                | to_dict - Converts the gen_stm8 bundle to a dictionary.
    '''
    ...
    def to_dict(self) -> dict[str, object]:
        '''
            Converts the gen_stm8 bundle to a dictionary.

            :return: Dictionary representation of the gen_stm8 bundle.
            :exceptions: None.
        '''
