...
Info
    A validator for the gen_stm8 bundle.
'''
...
class GenSTM8BundleValidator:
    ...
    @classmethod
    def validate(cls, bundle: GenSTM8Bundle) -> None:
        '''
            Validates the gen_stm8 bundle.

            :param bundle: The gen_stm8 bundle to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_stm8_bundle_validator::validate(...)'
        msg_bundle_none: str = 'the gen_stm8 bundle must be provided'
        msg_bundle_istype: str = 'the gen_stm8 bundle must be an instance of GenSTM8Bundle'
        ...
        istype(bundle, GenSTM8Bundle, ctx, msg_bundle_istype)
