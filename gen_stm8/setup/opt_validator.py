...
Info
    Validator for the gen_stm8 bundle options.
'''
...
class GenSTM8BundleOptionsValidator:
    '''
        Validator for the gen_stm8 bundle options.
    ...
    @classmethod
    def validate(cls, options: GenSTM8BundleOptions) -> None:
        '''
            Validates the gen_stm8 bundle options.

            :param options: The gen_stm8 bundle options to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_stm8_bundle_options_validator::validate(...)'
        msg_options_none: str = 'the gen_stm8 bundle options must be provided'
        msg_options_istype: str = 'the gen_stm8 bundle options must be a Mapping'

        not_none(options, ctx, msg_options_none)
        istype(options, Mapping, ctx, msg_options_istype)

        for attr_name, expected_type in GenSTM8BundleKeys.get_option_to_type().items():
