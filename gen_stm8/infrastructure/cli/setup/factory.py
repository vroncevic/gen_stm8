...
from gen_stm8.infrastructure.cli.setup.options import CLIBundleOptions
from gen_stm8.infrastructure.cli.setup.opt_validator import CLIBundleOptionsValidator
from gen_stm8.infrastructure.cli.setup.bundle import CLIBundle
from gen_stm8.infrastructure.cli.setup.keys import CLIBundleKeys
...
from gen_stm8.infrastructure.command.icommand_executor import ICommandExecutor
...
class CLIBundleFactory:
    ...
    def create_bundle(cls, options: CLIBundleOptions) -> CLIBundle:
        ...
        service_definition: ICommandDefinition = GenSTM8CommandDefinition()
        service_executor: ICommandExecutor = GenSTM8CommandExecutor(definition=service_definition)
