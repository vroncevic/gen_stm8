...
Info
    Defines GenSTM8CommandDefinition class.
'''
...
class GenSTM8CommandDefinition:
    '''
        CLI subcommand metadata definition for stm8 project generation.
    ...
    def help_text(self) -> str:
        ...
        '''
        return 'Generate STM8 project skeleton'
