...
Info
    Defines class STM8Setup with attribute(s) and method(s).
    Creates an API for generating STM8 project skeleton.
'''
...
class STM8Setup(FileCheck, ProConfig, ProName):
    '''
        Defines class STM8Setup with attribute(s) and method(s).
        Creates an API for generating STM8 project skeleton.
        ...
        It defines:
            ...
            :attributes:
                ...
                | _writer - Writer API.
            :methods:
                | __init__ - Initials STM8Setup constructor.
    ...
    def __init__(self, verbose: bool = False) -> None:
        '''
            Initials STM8Setup constructor.
    ...
    def gen_pro_setup(
        ...
        '''
            Generates STM8 project structure.
