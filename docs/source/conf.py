...
htmlhelp_basename: str = 'gen_stm8doc'
latex_elements: dict[str, object] = {}
latex_documents: list[tuple[str, ...]] = [(
    master_doc, 'gen_stm8.tex', 'gen_stm8 Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: list[tuple[str, ...]] = [(
    master_doc, 'gen_stm8', 'gen_stm8 Documentation', [author], 1
)]
texinfo_documents: list[tuple[str, ...]] = [(
    master_doc, 'gen_stm8', 'gen_stm8 Documentation', author, 'gen_stm8',
